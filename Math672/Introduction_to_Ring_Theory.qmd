...
3. A ring $R$ is a domain if and only if then the zero ideal is prime.
...
2. In function rings, it's common to construct the ideal of all functions $f$ which take the value $0$ at a given fixed point $x \in X$. Often, such an ideal is maximal. Except in some very strange circumstances, this sort of ideal will be maximal.
