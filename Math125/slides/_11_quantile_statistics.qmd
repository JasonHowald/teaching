...
- If count is even, median is average of middle two.
...
1. A data analyst needs to calculate Min, Q1, Median, Q3, and Max easily, quickly, and reliably, even for large datasets. What method should we use? 
