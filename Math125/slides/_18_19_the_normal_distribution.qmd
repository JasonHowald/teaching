...
#| fig-cap: "A strongly right skewed, non-normal distribution"
...
#| fig-alt: "An illustration of the Empirical Rule. The standard bell curve density function is shown. It has mean 0 and standard deviation 1. Shaded ranges plus or minus one, plus or minus two, and plus or minus three standard deviations are shown in color. The regions take up 68%, 95%, and 99.7% of the area of the figure."
import numpy as np
import matplotlib.pyplot as plt
...
# Mark the mean
ax.axvline(mu, color='black', linestyle='--', label=r'Mean ($\mu$) = 0')
